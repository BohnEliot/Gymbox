...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $kontenerek=[
        ["20'láb magas Vegyes",2300,2.35,2.43,2.39,5.89,2.59,6.09,13.86],
        ["40'láb magas Kardió",3750,2.35,2.43,2.68,12.03,2.59,12.19,28.27],
        ["40'láb magas Kondicionális",3940,2.35,2.43,2.69,12.03,2.89,12.19,28.27],
        ["45'láb magas Kondicionális",4820,2.35,2.43,2.69,13.55,2.89,13.71,31.188]
...
foreach ($felhasznalok as $value) {
    Felhasznalo::create([
        ...
        [
            ...
            ["ERX-500 elliptikus tréner",369000,"Toorx","Kardiovaszkuláris",64,150,59,179],
            ...
            ["Platinum V-series combhajlító gép",949900,"Tunturi","Kondicionális erősítő",230,152,82,215],
            ...
            ["G2B Multi",619000,"Body-Solid","Kondicionális erősítő",204,191,206,212],
